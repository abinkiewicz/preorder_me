'''
PreorderMe v1:
- wgranie fragmentu katalogu - zdjęcie strony z getrami w .jpg
- użycie Chat GPT (wynik w formie tabeli + klasa?)
- sprawdzenie - EDA (describe, czy model się nie pomylił itd.)
